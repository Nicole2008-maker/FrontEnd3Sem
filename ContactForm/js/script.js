function validarFormulario() {
    ...
    async function buscarEndereco(cep) {
        if (cep.trim().length < 8) {
            alert("CEP inválido. O CEP deve conter 8 digitos.");
            return false;
        }
        ...
        try {
            ...
            document.getElementById("ruaC").value = dados.logradouro;
    ...
    function aguardandoCampos() {
        ...
        document.getElementById("ruaC").value = "Aguardando...";
    }
